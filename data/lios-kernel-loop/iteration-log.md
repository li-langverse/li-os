...
| M2-115 | m2-complete | PASS | m1-completion + m2-completion + m2-progress + m2-kernel-smoke --check re-verified; GitHub push DISABLED + PR blocked (createPullRequest token scope); GitHub branch stale at 5ac9aed vs GitLab a0967e3; GitLab origin up-to-date (code_implementer-1781130589494) |
